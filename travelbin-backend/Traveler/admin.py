...
class TravelEntryAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'type', 'location', 'date', 'notes', 'contributor')
    search_fields = ('name', 'type', 'location', 'date', 'notes', 'contributor')
# Register your models here.

@admin.register(TravelDestination)
class TravelDestinationAdmin(admin.ModelAdmin):
    list_display = ('name', 'created_by', 'id')
    search_fields = ('name', 'created_by', 'id')

@admin.register(Permissions)
class PermissionsAdmin(admin.ModelAdmin):
        list_display = ('user','destination_id')
        search_fields = ('user','destination_id')
